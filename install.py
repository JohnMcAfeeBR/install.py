...
rDownloadURL = {"main": "https://github.com/amidevous/xtream-ui-beta-install/releases/download/1.0/mainnews.tar.gz", "sub": "https://github.com/amidevous/xtream-ui-beta-install/releases/download/1.0/main.tar.gz"}
